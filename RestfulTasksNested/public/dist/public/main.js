...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.taskToShow = function (task_id) {
        var _this = this;
        this.task = [];
        var observable = this._httpService.getTask(task_id);
        observable.subscribe(function (data) {
...
module.exports = "<h6>{{showTask.title}}</h6>\n<p>{{showTask.description}}</p>\n\n\n<p>asdf{{task}}</p>"
...
var TaskComponent = /** @class */ (function () {
    ...
    ], TaskComponent.prototype, "showTask", void 0);
...
module.exports = __webpack_require__(/*! C:\Users\Drew\MEAN_stack\Angular\RestfulTasksNested\public\src\main.ts */"./src/main.ts");
